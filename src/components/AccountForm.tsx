...
import type { AccountFormProps } from "../utils/type"
      ...
      <div className="bg-white rounded-lg max-w-md w-full p-6 max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              type="text"
              placeholder="e.g., BPI Checking, BDO Savings, Cash Wallet"
              value={name}
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">Optional: Choose from popular Philippine banks</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Current Balance (PHP)</label>
              <input
                type="number"
                step="0.01"
                placeholder="0.00"
